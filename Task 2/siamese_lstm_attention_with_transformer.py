...
class SiameseBiLSTMAttention(nn.Module):
    def __init__(
        ...
        self.transformer_encoder = trans.Transformer(self.embedding_size, self.embedding_size, d_model=self.embedding_size, N=6, heads=6)
    ...
    def forward_once(self, batch, lengths):
        ...
        return fc_out, annotation_matrix2, scores
